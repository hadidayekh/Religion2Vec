...
book2vec = w2v.load(os.path.join("..","data", "book2vec.w2v"))
points = read_pickle("../data/reduced_book.pkl")
...
d = get_most_similar_coordinates(sys.argv[1], int(sys.argv[2]), sys.argv[3])
if d is None:
	print ('absent')
else:
